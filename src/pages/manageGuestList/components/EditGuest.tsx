...
import GuestAffiliationSelection from "../../../features/guests/GuestAffiliationSelection";
import GuestInput from "../../../features/guests/GuestInput";
import MailingAddressForm from "../../../features/guests/MailingAddressForm";
import {
...
const EditGuest = (props: Props): JSX.Element => {
  ...
  const handleSubmit = (): void => {
    set(ref(database, "guests/" + group.id), {
      ...form.values,
    })
      .then(() => {

...
import { IconAdjustments, IconEye, IconEyeOff } from "@tabler/icons";
...
const AdminViewToggle = (): JSX.Element => {
    ...
    return (
        <ActionIcon className={classes.toggleButton} variant="filled" color="blue" onClick={(): void => toggleIsAdminViewEnabled()}>
            {icon}
        </ActionIcon>
    )
}
